...
pub(crate) fn rectangle(
    ...
    output.begin(rgba, &Transform::translation(x, y));
...
fn snapshot_testing() {
    ...
    circle.draw(16.0, 16.0, 224.0, 224.0, &mut output);
